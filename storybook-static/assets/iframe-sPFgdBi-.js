...
const w = {
  ...
  './lib/ImageZoom/ImageZoom.stories.ts': async () =>
    o(() => import('./ImageZoom.stories-Z9cuT-MW.js'), __vite__mapDeps([3, 1, 2]), import.meta.url),
};
async function P(i) {
  return w[i]();
}
const { composeConfigs: T, PreviewWeb: L, ClientApi: S } = __STORYBOOK_MODULE_PREVIEW_API__,
  I = async () => {
    const i = await Promise.all([
      o(() => import('./entry-preview-nBOAXpfX.js'), __vite__mapDeps([4, 2, 5]), import.meta.url),
      o(
        () => import('./entry-preview-docs-D8aCJcK0.js'),
        __vite__mapDeps([6, 7, 2, 8]),
        import.meta.url,
      ),
      o(() => import('./preview-Zh0YGT_q.js'), __vite__mapDeps([]), import.meta.url),
      o(() => import('./preview-FekBEZxm.js'), __vite__mapDeps([9, 8]), import.meta.url),
      o(() => import('./preview-TkXSQy1x.js'), __vite__mapDeps([]), import.meta.url),
      o(() => import('./preview-u8M_OEO2.js'), __vite__mapDeps([10, 8]), import.meta.url),
      o(() => import('./preview-bEa2SesL.js'), __vite__mapDeps([]), import.meta.url),
      o(() => import('./preview-OnO0tzRj.js'), __vite__mapDeps([11, 8]), import.meta.url),
      o(() => import('./preview-oX00bzS1.js'), __vite__mapDeps([12, 13]), import.meta.url),
    ]);
    return T(i);
  };
