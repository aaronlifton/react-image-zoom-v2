import { r as Fl, g as Ra, R as Da } from './index-DogsOklH.js';
var Il = {},
  zo = { exports: {} },
  ve = {},
  Po = { exports: {} },
...
function Xn(e, n) {
  for (Nt[e] = n, e = 0; e < n.length; e++) Mo.add(n[e]);
}
var Be = !(
    typeof window > 'u' ||
...
function Yl(e, n) {
  if (n) {
    if (Wa[e] && (n.children != null || n.dangerouslySetInnerHTML != null)) throw Error(y(137, e));
...
function Ka(e, n, t, r, l, i, u, o, s) {
  (gt = !1), (Er = null), Qa.apply($a, arguments);
}
function Ya(e, n, t, r, l, i, u, o, s) {
  if ((Ka.apply(this, arguments), gt)) {
    if (gt) {
      var d = Er;
      (gt = !1), (Er = null);
...
function st(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    ei || ((ei = !0), me.unstable_scheduleCallback(me.unstable_NormalPriority, sc)));
}
function Mt(e) {
  function n(l) {
    return st(l, e);
  ...
  for (; 0 < Ge.length && ((t = Ge[0]), t.blockedOn === null); )
    us(t), t.blockedOn === null && Ge.shift();
}
...
function Vi(e, n, t, r) {
  if (Nr) {
    ...
    if (l === null) xl(e, n, r, zr, t), Tu(e, r);
      ...
      for (; l !== null; ) {
        var i = $t(l);
        if ((i !== null && ts(i), (i = ni(e, n, t, r)), i === null && xl(e, n, r, zr, t), i === l))
          break;
        l = i;
      }
...
var nt = {
  ...
  Du = he(Yr),
  dc = V({}, Yr, { dataTransfer: 0 }),
  pc = he(dc),
  mc = V({}, Qt, { relatedTarget: 0 }),
  yl = he(mc),
  vc = V({}, nt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  hc = he(vc),
  yc = V({}, nt, {
...
var xc = V({}, Qt, {
  ...
  Pc = he(zc),
  Lc = V({}, nt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Tc = he(Lc),
  Mc = V({}, Yr, {
    deltaX: function (e) {
...
var Oc = Be && 'TextEvent' in window && !wt,
  as = Be && (!Wi || (wt && 8 < wt && 11 >= wt)),
  Iu = ' ',
  ju = !1;
function cs(e, n) {
  switch (e) {
...
function Ic(e, n) {
  if (Rn)
    return e === 'compositionend' || (!Wi && cs(e, n))
      ? ((e = ss()), (dr = Ai = Je = null), (Rn = !1), e)
      : null;
  switch (e) {
    case 'paste':
      return null;
...
function Au() {
  kt && (kt.detachEvent('onpropertychange', ms), (Rt = kt = null));
}
function ms(e) {
  if (e.propertyName === 'value' && Xr(Rt)) {
    var n = [];
    ds(n, Rt, e, Fi(e)), Yo(Uc, n);
  }
}
function Ac(e, n, t) {
  e === 'focusin'
    ? (Au(), (kt = n), (Rt = t), kt.attachEvent('onpropertychange', ms))
    : e === 'focusout' && Au();
}
function Bc(e) {
...
var Te = typeof Object.is == 'function' ? Object.is : Qc;
function Dt(e, n) {
  if (Te(e, n)) return !0;
...
cn(gs, 'onAnimationEnd');
cn(ws, 'onAnimationIteration');
cn(ks, 'onAnimationStart');
cn('dblclick', 'onDoubleClick');
cn('focusin', 'onFocus');
cn('focusout', 'onBlur');
cn(Ss, 'onTransitionEnd');
...
var ht =
  ...
  Gc = new Set('cancel close invalid load scroll toggle'.split(' ').concat(ht));
function $u(e, n, t) {
        ...
        if (
          ...
          if (
            ...
            (e === 'pointerout' || e === 'pointerover') &&
              ((k = Fu), (h = 'onPointerLeave'), (c = 'onPointerEnter'), (a = 'pointer')),
            (F = g == null ? p : Fn(g)),
            (f = w == null ? p : Fn(w)),
          ...
          g !== null && Ku(m, p, g, k, !1), w !== null && F !== null && Ku(m, F, w, k, !0);
        }
      }
      e: {
        if (
...
var tt = Math.random().toString(36).slice(2),
  ...
  si = '__reactEvents$' + tt,
  nf = '__reactListeners$' + tt,
  tf = '__reactHandles$' + tt;
function yn(e) {
  var n = e[De];
  if (n) return n;
...
function _s(e, n, t) {
  ...
  r = r.getChildContext();
  for (var l in r) if (!(l in n)) throw Error(y(108, Aa(e) || 'Unknown', l));
  return V({}, t, r);
}
function Mr(e) {
  return (
...
function dn() {
  if (!Nl && je !== null) {
    ...
    try {
      ...
      throw (je !== null && (je = je.slice(e + 1)), Jo(Ii, dn), l);
    } finally {
      (M = n), (Nl = !1);
    }
  }
  ...
  if (I) {
    ...
    if (n) {
      ...
      if (!qu(e, n)) {
        ...
        n = tn(t.nextSibling);
        var r = pe;
        n && qu(e, n) ? Ps(r, t) : ((e.flags = (e.flags & -4097) | 2), (I = !1), (pe = e));
      }
    } else {
      if (ci(e)) throw Error(y(418));
...
function ir(e) {
  ...
  if (
    ...
    if (ci(e)) throw (Ls(), Error(y(418)));
    for (; n; ) Ps(e, n), (n = tn(n.nextSibling));
  }
  if ((bu(e), e.tag === 13)) {
...
var lf = $e.ReactCurrentBatchConfig;
function _e(e, n) {
  if (e && e.defaultProps) {
...
function mi(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = Rs), qi(e);
  var i = n.contextType;
  typeof i == 'object' && i !== null
    ? (l.context = Se(i))
  ...
  if (((e = t.ref), e !== null && typeof e != 'function' && typeof e != 'object')) {
    if (t._owner) {
      ...
      return n !== null && n.ref !== null && typeof n.ref == 'function' && n.ref._stringRef === i
        ...
        : ((n = function (u) {
            var o = l.refs;
            o === Rs && (o = l.refs = {}), u === null ? delete o[i] : (o[i] = u);
          }),
          (n._stringRef = i),
          n);
    }
...
function Os(e) {
  ...
  function s(c, a, f, h) {
    ...
    return E === Mn
      ...
      : a !== null &&
          (a.elementType === E ||
            (typeof E == 'object' && E !== null && E.$$typeof === Ye && lo(E) === a.type))
            ...
            for (var E = f.key, x = a; x !== null; ) {
              if (x.key === E) {
                if (((E = f.type), E === Mn)) {
                  ...
                  x.elementType === E ||
                  (typeof E == 'object' && E !== null && E.$$typeof === Ye && lo(E) === x.type)
                ) {
                  t(c, x.sibling),
                    (a = l(x, f.props)),
                    (a.ref = ct(c, x, f)),
...
function ru(e, n, t, r, l, i) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (vr.current = e === null || e.memoizedState === null ? cf : ff),
    (e = t(r, l)),
    Et)
  ) {
    i = 0;
    do {
      ...
      (i += 1), (X = $ = null), (n.updateQueue = null), (vr.current = df), (e = t(r, l));
    } while (Et);
  }
  if (
    ((vr.current = Vr),
...
function As(e, n, t, r) {
  (n.value = t), (n.getSnapshot = r), Hs(n) && Ws(e);
}
function Bs(e, n, t) {
  return t(function () {
    Hs(n) && Ws(e);
...
function Xs(e, n, t) {
  return (t = t != null ? t.concat([e]) : null), br(4, 4, Ys.bind(null, n, e), t);
}
function uu() {}
function Gs(e, n) {
  var t = Ee();
...
function Js(e, n, t) {
  return xn & 21
    ? (Te(t, n) || ((t = es()), (U.lanes |= t), (_n |= t), (e.baseState = !0)), n)
...
function sf(e, n, t) {
  var r = un(e);
  if (((t = { lane: r, action: t, hasEagerState: !1, eagerState: null, next: null }), bs(e)))
    ea(n, t);
...
function af(e, n, t) {
  ...
  if (bs(e)) ea(n, l);
    ...
    (t = Ts(e, n, l, r)), t !== null && ((l = le()), Le(t, e, r, l), na(t, n, r));
  }
}
function bs(e) {
  var n = e.alternate;
...
var Vr = {
  ...
  cf = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (t = t != null ? t.concat([e]) : null), hr(4194308, 4, Ys.bind(null, n, e), t);
    },
    ...
    useTransition: function () {
      var e = io(!1),
        n = e[0];
      return (e = of.bind(null, e[1])), (Re().memoizedState = e), [n, e];
    },
  ...
  df = {
    ...
    useDeferredValue: function (e) {
      var n = Ee();
      return $ === null ? (n.memoizedState = e) : Js(n, $.memoizedState, e);
    },
    useTransition: function () {
      var e = Tl(At)[0],
        n = Ee().memoizedState;
...
function po(e, n, t, r, l) {
  ...
  if ((Kn(n, l), n.stateNode === null)) yr(e, n), Ds(n, t, r), mi(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      o = n.memoizedProps;
    u.props = o;
...
function vf(e, n, t, r, l, i, u) {
  ...
  return l.data === '$?'
    ? ((n.flags |= 128), (n.child = e.child), (n = Pf.bind(null, e)), (l._reactRetry = n), null)
    : ((e = i.treeContext),
      (de = tn(l.nextSibling)),
      (pe = n),
      (I = !0),
    ...
    case 13:
      ...
      return n.flags & 128
        ...
        : ((r = r !== null),
          ...
          null);
    case 4:
      return qn(), ki(e, n), e === null && Ot(n.stateNode.containerInfo), ee(n), null;
    case 10:
...
function pa(e) {
  var n = e.alternate;
  n !== null && ((e.alternate = null), pa(n)),
    (e.child = null),
    (e.deletions = null),
    (e.sibling = null),
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null && (delete n[De], delete n[It], delete n[si], delete n[nf], delete n[tf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
    ...
    case 5:
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), s !== null))
          try {
            o === 'input' && i.type === 'radio' && i.name != null && jo(l, i), Xl(o, u);
            var d = Xl(o, i);
...
function ce(e, n) {
  ...
  if (r === 0) t !== null && Lu(t), (e.callbackNode = null), (e.callbackPriority = 0);
    ...
    if ((t != null && Lu(t), n === 1))
      e.tag === 0 ? rf(Eo.bind(null, e)) : Ns(Eo.bind(null, e)),
        bc(function () {
          !(T & 6) && dn();
        }),
        (t = null);
...
function ga(e, n) {
  ...
  return ce(e, W()), e.callbackNode === t ? ga.bind(null, e) : null;
}
function zi(e, n) {
  var t = xt;
  return (
    ...
    try {
      ...
      e: {
        ...
        if (
          ...
          var F = so(u);
          if (F !== null) {
            !(F.flags & 65536) && (F.flags |= 256), ao(F, u, o, i, n), Yi(bn(s, o));
            break e;
          }
        }
...
function Sa(e) {
  var n = xa(e.alternate, e, fe);
  (e.memoizedProps = e.pendingProps), n === null ? Ea(e) : (Q = n), (su.current = null);
}
function Ea(e) {
  var n = e;
  do {
...
function hn(e, n, t) {
  var r = M,
    l = ke.transition;
  try {
    (ke.transition = null), (M = 1), Nf(e, n, t, r);
  } finally {
    (ke.transition = l), (M = r);
  }
  return null;
...
xa = function (e, n, t) {
  ...
  else (oe = !1), I && n.flags & 1048576 && zs(n, Dr, n.index);
  switch (((n.lanes = 0), n.tag)) {
    ...
    case 3:
      e: {
        ...
        (r = n.pendingProps), (i = n.memoizedState), (l = i.element), Ms(e, n), Ir(n, r, null, t);
...
function tl(e, n, t, r) {
  return (
    (e = we(22, e, r, n)), (e.elementType = Oo), (e.lanes = t), (e.stateNode = { isHidden: !1 }), e
  );
}
function Dl(e, n, t) {
...
$o = fu;
Ko = Nn;
var If = { usingClientEntryPoint: !1, Events: [$t, Fn, Zr, Wo, Qo, fu] },
  dt = {
  ...
  jf = {
    ...
    findFiberByHostInstance: dt.findFiberByHostInstance || Of,
...
ve.hydrateRoot = function (e, n, t) {
  ...
  if (
    ...
    (n = za(n, null, e, 1, t ?? null, l, !1, i, u)),
    (e[He] = n.current),
    Ot(e),
    r)
  )
...
var $r = new Map(),
  ...
  Hf = async (e, n) => {
    ...
    return new Promise((r) => {
      t.render(Da.createElement(Uf, { callback: () => r(null) }, e));
    });
  },
  Wf = (e, n) => {
    let t = $r.get(e);
...
export { Bf as R, Ta as a, Hf as r, Wf as u };
