import { c as R } from './_commonjsHelpers-4gQjN7DL.js';
function F(l, e) {
    ...
    if (typeof r != 'string' && !Array.isArray(r)) {
      for (const o in r)
        if (o !== 'default' && !(o in l)) {
          ...
          i && Object.defineProperty(l, o, i.get ? i : { enumerable: !0, get: () => r[o] });
        }
    }
  }
...
var w = (a.spyOn = I = a.mocked = S = a.fn = E = a.ModuleMocker = void 0);
function h(l, e, t) {
  return (
    e in l
      ? Object.defineProperty(l, e, { value: t, enumerable: !0, configurable: !0, writable: !0 })
      : (l[e] = t),
    l
  );
}
...
function x(l, e) {
  ...
  switch (e) {
    ...
    case 4:
      ...
      break;
    case 5:
      t = function (r, o, i, s, n) {
        return l.apply(this, arguments);
      };
      break;
    case 6:
      t = function (r, o, i, s, n, c) {
        return l.apply(this, arguments);
      };
      break;
    case 7:
      t = function (r, o, i, s, n, c, u) {
        return l.apply(this, arguments);
      };
      break;
    case 8:
      t = function (r, o, i, s, n, c, u, f) {
        return l.apply(this, arguments);
      };
      break;
    case 9:
      t = function (r, o, i, s, n, c, u, f, p) {
        return l.apply(this, arguments);
      };
      break;
    default:
...
function O(l) {
  return Object.prototype.toString.apply(l).slice(8, -1);
}
function G(l) {
  const e = O(l);
...
class v {
  constructor(e) {
    h(this, '_environmentGlobal', void 0),
      h(this, '_mockState', void 0),
      h(this, '_mockConfigRegistry', void 0),
      h(this, '_spyState', void 0),
      h(this, '_invocationCallCounter', void 0),
  ...
  _getSlots(e) {
    ...
    const t = new Set(),
      ...
      i = this._environmentGlobal.RegExp.prototype,
      s = Object.prototype,
      n = Function.prototype,
      c = RegExp.prototype;
    for (; e != null && e !== r && e !== o && e !== i && e !== s && e !== n && e !== c; ) {
      const u = Object.getOwnPropertyNames(e);
      for (let f = 0; f < u.length; f++) {
        const p = u[f];
        if (!V(e, p)) {
          const k = Object.getOwnPropertyDescriptor(e, p);
          ((k !== void 0 && !k.get) || e.__esModule) && t.add(p);
        }
      }
  ...
  _makeComponent(e, t) {
    ...
    if (e.type === 'function') {
      const r = (e.members && e.members.prototype && e.members.prototype.members) || {},
        ...
        i = this,
        s = x(function (...c) {
          const u = i._ensureMockState(n),
            f = i._ensureMockConfig(n);
          u.instances.push(this), u.calls.push(c);
          const p = { type: 'incomplete', value: void 0 };
          u.results.push(p), u.invocationCallOrder.push(i._invocationCallCounter++);
          let k,
            M,
            y = !1;
          try {
            k = (() => {
              if (this instanceof n) {
                o.forEach((g) => {
                  if (r[g].type === 'function') {
                    const P = this[g];
                    (this[g] = i.generateFromMetadata(r[g])), (this[g]._protoImpl = P);
                  }
                });
                const b = f.specificMockImpls.length ? f.specificMockImpls.shift() : f.mockImpl;
                return b && b.apply(this, arguments);
              }
              let m = f.specificMockImpls.shift();
              if ((m === void 0 && (m = f.mockImpl), m)) return m.apply(this, arguments);
              if (n._protoImpl) return n._protoImpl.apply(this, arguments);
            })();
          } catch (m) {
            throw ((M = m), (y = !0), m);
          } finally {
            (p.type = y ? 'throw' : 'return'), (p.value = y ? M : k);
          }
          return k;
        }, e.length || 0),
      ...
      return (
        ...
        (n.mockReturnValueOnce = (c) => n.mockImplementationOnce(() => c)),
        (n.mockResolvedValueOnce = (c) => n.mockImplementationOnce(() => Promise.resolve(c))),
        (n.mockRejectedValueOnce = (c) => n.mockImplementationOnce(() => Promise.reject(c))),
        (n.mockReturnValue = (c) => n.mockImplementation(() => c)),
        (n.mockResolvedValue = (c) => n.mockImplementation(() => Promise.resolve(c))),
        (n.mockRejectedValue = (c) => n.mockImplementation(() => Promise.reject(c))),
        (n.mockImplementationOnce = (c) => (
          this._ensureMockConfig(n).specificMockImpls.push(c), n
        )),
        (n.mockImplementation = (c) => {
          const u = this._ensureMockConfig(n);
          return (u.mockImpl = c), n;
        }),
        (n.mockReturnThis = () =>
  ...
  _createMockFunction(e, t) {
    ...
    let i = '';
    if (r && r.startsWith(o))
      do (r = r.substring(o.length)), (i = '.bind(null)');
      while (r && r.startsWith(o));
    if (r === d) return t;
    (D.has(r) || /^\d/.test(r)) && (r = '$' + r), C.test(r) && (r = r.replace(A, '$'));
    const s = 'return function ' + r + '() {return ' + d + '.apply(this,arguments);}' + i;
  ...
  _generateMock(e, t, r) {
    ...
    return (
      ...
      this._getSlots(e.members).forEach((i) => {
        const s = (e.members && e.members[i]) || {};
        s.ref != null
          ? t.push(
              (function (n) {
                return () => (o[i] = r[n]);
  ...
  getMetadata(e, t) {
    ...
    if (!i) return null;
    const s = { type: i };
    if (i === 'constant' || i === 'collection' || i === 'undefined' || i === 'null')
      return (s.value = e), s;
    i === 'function' &&
      ((s.name = e.name), e._isMockFunction === !0 && (s.mockImpl = e.getMockImplementation())),
      (s.refID = r.size),
      r.set(e, s.refID);
    let n = null;
    return (
      i !== 'array' &&
        this._getSlots(e).forEach((c) => {
          if (i === 'function' && e._isMockFunction === !0 && c.match(/^mock/)) return;
          const u = this.getMetadata(e[c], r);
          u && (n || (n = {}), (n[c] = u));
        }),
      n && (s.members = n),
      s
  ...
  spyOn(e, t, r) {
    ...
    if (!this.isMockFunction(o)) {
      ...
      const i = Object.prototype.hasOwnProperty.call(e, t);
      let s = Object.getOwnPropertyDescriptor(e, t),
        n = Object.getPrototypeOf(e);
      for (; !s && n !== null; )
        (s = Object.getOwnPropertyDescriptor(n, t)), (n = Object.getPrototypeOf(n));
      let c;
      if (s && s.get) {
        const u = s.get;
        (c = this._makeComponent({ type: 'function' }, () => {
          (s.get = u), Object.defineProperty(e, t, s);
        })),
          (s.get = () => c),
  ...
  _spyOnProperty(e, t, r = 'get') {
    ...
    for (; !o && i !== null; )
      (o = Object.getOwnPropertyDescriptor(i, t)), (i = Object.getPrototypeOf(i));
...
var E = (a.ModuleMocker = v);
const _ = new v(R),
  W = _.fn.bind(_);
var S = (a.fn = W);
const j = _.spyOn.bind(_);
w = a.spyOn = j;
const T = _.mocked.bind(_);
var I = (a.mocked = T);
const z = F(
  {
    __proto__: null,
