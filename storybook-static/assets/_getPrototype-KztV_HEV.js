import { c as Bu, g as ju } from './index-DogsOklH.js';
...
var An = eu,
  ...
  Fn = qu;
function Cn() {
  (this.size = 0), (this.__data__ = { hash: new se(), map: new (Fn || on)(), string: new se() });
}
var ln = Cn;
function cn(u) {
  var e = typeof u;
...
function ks(u, e, r, t, a, i) {
  ...
  if (F && !T)
    return i || (i = new Pu()), n || Rs(u) ? Ns(u, e, r, t, a, i) : Ps(u, e, p, r, t, a, i);
  if (!(r & Ls)) {
...
function a1(u, e, r) {
  ...
  return i || ++t != a
    ? i
    : ((a = u == null ? 0 : u.length), !!a && r1(a) && e1(n, a) && (u1(u) || ZD(u)));
}
var n1 = a1,
  i1 = YD,
  s1 = n1;
    ...
    (function (C) {
      ...
      (O.prototype.addError = function (A) {
        ...
        (O.prototype.parseName = function () {
          ...
          if (m(this._title))
            if (
              ((this._tag.name = fu(this._last, V && c(this._title), d(this._title))),
              this._tag.name)
            )
              (A = this._tag.name),
                A.charAt(0) === '[' &&
...
var SA = { tags: ['param', 'arg', 'argument', 'returns', 'ignore', 'deprecated'] },
  $A = (u, e = SA) => {
...
var KA = (u, e) => {
  ...
  return { name: u, type: UA(r), required: a, description: t, defaultValue: GA(i, r) };
};
...
var WA = (u, e) => {
  ...
  return { name: u, type: HA(e), required: t, description: r, defaultValue: qA(e) };
};
function zA(u) {
...
function nr(u, e, r) {
  ...
  return { name: u, type: zA(e), required: a, description: t, defaultValue: QA(i, e) };
}
function Su(u, e) {
  var r;
  if (e.includesJsDoc) {
...
var Fo = (u) => {
  ...
  ao = ((u) => ((u.AUTO = 'auto'), (u.CODE = 'code'), (u.DYNAMIC = 'dynamic'), u))(ao || {}),
  no = Re,
